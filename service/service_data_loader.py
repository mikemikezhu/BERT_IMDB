...
class DataLoaderService:
    ...
    def load_data(self, load_data_param, test_only=False):

        bert_train_data_loader, bert_val_data_loader = None, None
        ...
        if not test_only:
            ...
            bert_train_imdb_x, bert_train_imdb_y = zip(
                *bert_train_imdb_combined)
            ...
            bert_train_dataset = ImdbDataset(
                bert_train_imdb_x, bert_train_imdb_y)
